...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Все кандидаты</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <a class="btn btn-primary" href="<c:url value="/admin/reg/user/show/registration">">Добавить кандидата</a>
                </div>
            </div>
