...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  ...
  <main class="mdl-layout__content">
      <div class="page-content demo-card-square mdl-shadow--2dp">
                ...
                <ul class="demo-list-item mdl-list">
                  ...
                  <li class="mdl-list__item">
                    <span class="mdl-list__item-primary-content">
                      ...
                      <a id="add_sendors">Добавить пользователя</a>
                    </span>
                  </li>
                  <li class="mdl-list__item">
                    <span class="mdl-list__item-primary-content">
                      <i class="material-icons mdl-list__item-avatar">remove</i>                      
                      <a id="">Удалить пользователя</a>
                    </span>
                  </li>
                 </ul>
            </div>
            ...
            <div class="mdl-cell mdl-cell--10-col mdl-cell--3-col-phone mdl-cell--1-col-phone">
                ...
                <p class="header_text">Ваши  пользователи</p>
  ...
  <script>
      $(document).ready(function(){
          search();
          $('#add_sendors').click(function()
          {
              var location = window.location.href;
              location = location.substring(0, location.indexOf('/sendors'));
              window.location = location + '/add_sendors?candidate_id='+$('#candidate_id').val();              
          });
